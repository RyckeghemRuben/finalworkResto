...
<div class="container">
    <div class="row" style="margin: 2em 0 0 0">
        <div class="col-lg-12">
        <form>
            <div class="panel-body"><a href="{{ route('login') }}" class="btn btn-danger btn-block">Admin</a></div>
        </form>
        </div>
    </div>
    <div class="row" style="margin: 1em 0 0 0">
        <div class="col-lg-12">
        <form>
            <div class="panel-body"><a class="btn btn-danger btn-block" data-toggle="collapse" href="#multiCollapseExample1" role="button" aria-expanded="false" aria-controls="multiCollapseExample1">Klant</a></div>
        </form>
        </div>
    </div>
    <div class="row">
